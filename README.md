...
新規プラグインの作成手順は [wxp-gain-example](https://github.com/novonotes/wxp-gain-example) を参照してください。
...
| [`wxp-gain-example`](https://github.com/novonotes/wxp-gain-example) | gain plugin の参照実装は別リポジトリで管理 |
